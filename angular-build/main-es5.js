...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppHomeDashboardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppMoviesMovieDetailsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _movies_movie_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./movies/movie.module */
    ...
    var _nav_navbar_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./nav/navbar.component */
    "./src/app/nav/navbar.component.ts");
    /* harmony import */


    var _shared_ellipsis_pipe__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./shared/ellipsis.pipe */
    "./src/app/shared/ellipsis.pipe.ts");
    /* harmony import */


    var _home_dashboard_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./home/dashboard.component */
    "./src/app/home/dashboard.component.ts");
    /* harmony import */


    var _shared_clip_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./shared/clip.service */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_13__["AppComponent"], _nav_navbar_component__WEBPACK_IMPORTED_MODULE_14__["NavbarComponent"], _home_dashboard_component__WEBPACK_IMPORTED_MODULE_16__["DashboardComponent"], _shared_ellipsis_pipe__WEBPACK_IMPORTED_MODULE_15__["EllipsisPipe"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_18__["RouterModule"].forRoot([{
        path: "home",
        component: _home_dashboard_component__WEBPACK_IMPORTED_MODULE_16__["DashboardComponent"]
      }, {
        path: "",
        redirectTo: "home",
        pathMatch: "full"
        ...
        redirectTo: "home",
        pathMatch: "full"
      }]), _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeModule"], _movies_movie_module__WEBPACK_IMPORTED_MODULE_12__["MoviesModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_19__["BrowserAnimationsModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_6__["MatMenuModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_7__["MatButtonModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_8__["MatInputModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_9__["MatDividerModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_11__["MatTabsModule"]],
      providers: [_shared_clip_service__WEBPACK_IMPORTED_MODULE_17__["ClipService"]],
  ...
  /***/
  function srcAppHomeDashboardComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppHomeDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_clip_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../shared/clip.service */
    "./src/app/shared/clip.service.ts");
    ...
    /*#__PURE__*/
    function () {
      function DashboardComponent(clipService) {
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function getNowPlaying() {
          ...
          this.clipService.getNowPlaying().subscribe(function (res) {
            console.log(res.results);
            _this.playingMovies = res.results.slice(0, 4);
            console.log(_this.playingMovies);
          });
        }
      }, {
        key: "getPopular",
        value: function getPopular() {
          ...
          this.clipService.getPopular().subscribe(function (res) {
            console.log(res.results);
            _this2.popMovies = res.results.slice(0, 4);
            console.log(_this2.popMovies);
          });
        }
      }, {
        key: "getTopRated",
        value: function getTopRated() {
          ...
          this.clipService.getTopRated().subscribe(function (res) {
            console.log(res.results);
            _this3.ratedMovies = res.results.slice(0, 4);
            console.log(_this3.ratedMovies);
          });
        }
      }, {
        key: "getUpcoming",
        value: function getUpcoming() {
          ...
          this.clipService.getUpcoming().subscribe(function (res) {
            console.log(res.results);
            _this4.upcomingMovies = res.results.slice(0, 4);
            console.log(_this4.upcomingMovies);
          });
        }
      }]);
    ...
    DashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/home/dashboard.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./dashboard.component.css */
      "./src/app/home/dashboard.component.css")).default]
    })], DashboardComponent);
    /***/
  },
  ...
  /***/
  function srcAppMoviesMovieDetailsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppMoviesMovieDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_clip_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../shared/clip.service */
    "./src/app/shared/clip.service.ts");
    ...
    /*#__PURE__*/
    function () {
      function MovieDetailsComponent(router, clipService) {
      ...
      _createClass(MovieDetailsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          console.log(id);
          this.clipService.getMovie(id).subscribe(function (movie) {
            console.log(movie);
            _this5.movie = movie;
          });
          this.clipService.getCredits(id).subscribe(function (credits) {
            console.log(credits);
            _this5.credits = credits;
          });
        }
      }]);
    ...
    MovieDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/movies/movie-details.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./movie-details.component.css */
      "./src/app/movies/movie-details.component.css")).default]
  ...
  /***/
  function srcAppMoviesMovieModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _now_playing_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./now-playing.component */
    "./src/app/movies/now-playing.component.ts");
    /* harmony import */


    var _popular_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./popular.component */
    "./src/app/movies/popular.component.ts");
    /* harmony import */


    var _top_rated_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./top-rated.component */
    "./src/app/movies/top-rated.component.ts");
    /* harmony import */


    var _upcoming_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./upcoming.component */
    "./src/app/movies/upcoming.component.ts");
    /* harmony import */


    var _movie_details_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./movie-details.component */
    "./src/app/movies/movie-details.component.ts");
    /* harmony import */


    var _shared_safe_pipe__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../shared/safe.pipe */
    ...
    MoviesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild([{
        path: "now_playing",
        component: _now_playing_component__WEBPACK_IMPORTED_MODULE_7__["NowPlayingMovieComponent"]
      }, {
        path: "popular",
        component: _popular_component__WEBPACK_IMPORTED_MODULE_8__["PopularMovieComponent"]
      }, {
        path: "top_rated",
        component: _top_rated_component__WEBPACK_IMPORTED_MODULE_9__["TopRatedMovieComponent"]
      }, {
        path: "upcoming",
        component: _upcoming_component__WEBPACK_IMPORTED_MODULE_10__["UpcomingMovieComponent"]
      }, {
        path: "now_playing/:id",
        component: _movie_details_component__WEBPACK_IMPORTED_MODULE_11__["MovieDetailsComponent"]
      }, {
        path: "popular/:id",
        component: _movie_details_component__WEBPACK_IMPORTED_MODULE_11__["MovieDetailsComponent"]
      }, {
        ...
        redirectTo: "home",
        pathMatch: "full"
      }]), _angular_material_tabs__WEBPACK_IMPORTED_MODULE_4__["MatTabsModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIconModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardModule"]],
      declarations: [_now_playing_component__WEBPACK_IMPORTED_MODULE_7__["NowPlayingMovieComponent"], _popular_component__WEBPACK_IMPORTED_MODULE_8__["PopularMovieComponent"], _top_rated_component__WEBPACK_IMPORTED_MODULE_9__["TopRatedMovieComponent"], _upcoming_component__WEBPACK_IMPORTED_MODULE_10__["UpcomingMovieComponent"], _movie_details_component__WEBPACK_IMPORTED_MODULE_11__["MovieDetailsComponent"], _shared_safe_pipe__WEBPACK_IMPORTED_MODULE_12__["SafePipe"]]
    })], MoviesModule);
    /***/
  },
  ...
  /***/
  function srcAppMoviesNowPlayingComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NowPlayingMovieComponent", function () {
      return NowPlayingMovieComponent;
    });
    /* harmony import */
    ...
    var _shared_clip_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../shared/clip.service */
    "./src/app/shared/clip.service.ts");

    var NowPlayingMovieComponent =
    /*#__PURE__*/
    function () {
      function NowPlayingMovieComponent(http, router, clipService) {
        _classCallCheck(this, NowPlayingMovieComponent);
      ...
      _createClass(NowPlayingMovieComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getNowPlaying();
        }
        ...
        value: function getNowPlaying() {
          ...
          this.clipService.getNowPlaying().subscribe(function (res) {
            console.log(res.results);
            _this6.playingMovies = res.results;
          });
        }
      }]);
    ...
    NowPlayingMovieComponent.ctorParameters = function () {
      return [{
    ...
    NowPlayingMovieComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  /***/
  function srcAppMoviesPopularComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PopularMovieComponent", function () {
    ...
    var PopularMovieComponent =
    /*#__PURE__*/
    function () {
      function PopularMovieComponent(router, clipService) {
        _classCallCheck(this, PopularMovieComponent);
      ...
      _createClass(PopularMovieComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getPopular();
        }
    ...
    PopularMovieComponent.ctorParameters = function () {
      return [{
        type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]
      }, {
        type: _shared_clip_service__WEBPACK_IMPORTED_MODULE_3__["ClipService"]
    ...
    PopularMovieComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  /***/
  function srcAppMoviesTopRatedComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TopRatedMovieComponent", function () {
      return TopRatedMovieComponent;
    });
    /* harmony import */
    ...
    var TopRatedMovieComponent =
    /*#__PURE__*/
    function () {
      function TopRatedMovieComponent(clipService) {
        _classCallCheck(this, TopRatedMovieComponent);

        this.clipService = clipService;
        this.baseUrl = "https://image.tmdb.org/t/p/";
      }

      _createClass(TopRatedMovieComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getTopRated();
        }
        ...
        value: function getTopRated() {
          ...
          this.clipService.getTopRated().subscribe(function (res) {
            console.log(res.results);
            _this8.ratedMovies = res.results;
          });
        }
      }]);
    ...
    TopRatedMovieComponent.ctorParameters = function () {
      return [{
        type: _shared_clip_service__WEBPACK_IMPORTED_MODULE_2__["ClipService"]
      }];
    };

    TopRatedMovieComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  /***/
  function srcAppMoviesUpcomingComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UpcomingMovieComponent", function () {
    ...
    var UpcomingMovieComponent =
    /*#__PURE__*/
    function () {
      function UpcomingMovieComponent(clipService) {
        _classCallCheck(this, UpcomingMovieComponent);

        this.clipService = clipService;
        this.baseUrl = "https://image.tmdb.org/t/p/";
      }

      _createClass(UpcomingMovieComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getUpcoming();
        }
        ...
        value: function getUpcoming() {
          ...
          this.clipService.getUpcoming().subscribe(function (res) {
            console.log(res.results);
            _this9.upcomingMovies = res.results;
          });
        }
      }]);
    ...
    UpcomingMovieComponent.ctorParameters = function () {
      return [{
        type: _shared_clip_service__WEBPACK_IMPORTED_MODULE_2__["ClipService"]
      }];
    };

    UpcomingMovieComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  /***/
  function srcAppNavNavbarComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppNavNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NavbarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/nav/navbar.component.css")).default]
    })], NavbarComponent);
    /***/
  },
  ...
  /***/
  function srcAppSharedClipServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ClipService", function () {
      return ClipService;
    });
    /* harmony import */
    ...
    function () {
      function ClipService(http) {
        _classCallCheck(this, ClipService);
      ...
      _createClass(ClipService, [{
        key: "getNowPlaying",
        value: function getNowPlaying() {
          return this.http.get("".concat(this.baseUrl, "movie/now_playing?api_key=").concat(this.apiKey, "&language=").concat(this.language, "&page=").concat(this.page, "&region=").concat(this.region));
        }
      }, {
        key: "getPopular",
        value: function getPopular() {
          return this.http.get("".concat(this.baseUrl, "movie/popular?api_key=").concat(this.apiKey, "&language=").concat(this.language, "&page=").concat(this.page, "&region=").concat(this.region));
        }
      }, {
        key: "getTopRated",
        value: function getTopRated() {
          return this.http.get("".concat(this.baseUrl, "movie/top_rated?api_key=").concat(this.apiKey, "&language=").concat(this.language, "&page=").concat(this.page, "&region=").concat(this.region));
        }
      }, {
        key: "getUpcoming",
        value: function getUpcoming() {
          return this.http.get("".concat(this.baseUrl, "movie/upcoming?api_key=").concat(this.apiKey, "&language=").concat(this.language, "&page=").concat(this.page, "&region=").concat(this.region));
        }
      }, {
        key: "getMovie",
        value: function getMovie(id) {
          return this.http.get( // tslint:disable-next-line: max-line-length
          "".concat(this.baseUrl, "movie/").concat(id, "?api_key=").concat(this.apiKey, "&language=").concat(this.language, "&append_to_response=").concat(this.atr, "&include_image_language=en,null"));
        }
      }, {
        key: "getCredits",
        value: function getCredits(id) {
          return this.http.get("".concat(this.baseUrl, "movie/").concat(id, "/credits?api_key=").concat(this.apiKey));
        }
      }]);
    ...
    ClipService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    ClipService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], ClipService);
    /***/
  },
  ...
  /***/
  function srcAppSharedEllipsisPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\ANGULAR\arm-clips\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
